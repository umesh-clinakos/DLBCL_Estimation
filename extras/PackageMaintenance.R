...
OhdsiRTools::checkUsagePackage("DLBCLEstimation")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/DLBCLEstimation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DLBCLEstimation.pdf")
...
OhdsiRTools::createRenvLockFile("DLBCLEstimation")
